...
Examples:
  ...
  python visualize_from_results.py --experiment train_val_500rounds --save my_plot.png
    ...
    group.add_argument(
        ...
        "-e",
        type=str,
        help="Experiment name (e.g., train_val_500rounds)",
    )
    ...
    parser.add_argument(
        "--no-plot", action="store_true", help="Print summary only, no plot"
    )
